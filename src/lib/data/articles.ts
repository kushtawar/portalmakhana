...
export const articles: Article[] = [
  {
    id: "a7",
    slug: "the-story-of-makhana-pond-to-packet",
    title: "The Story of Makhana: From Pond to Packet",
    excerpt:
      "From a seed that grows in water to your snack bowl — how Makhana is collected, processed, sorted and packed.",
    content: [
      "Makhana's journey begins with the seeds of the Euryale ferox plant, which grows in water. Through traditional processing, these seeds are transformed into the familiar white, crunchy Makhana.",
      "1. Collection: Makhana seeds are collected from water bodies.",
      "2. Cleaning: The seeds are cleaned and unwanted impurities are removed.",
      "3. Drying: The seeds are dried in suitable conditions.",
      "4. Processing: The dried seeds are expanded through traditional heat processing to make Makhana.",
      "5. Sorting: Makhana is sorted and selected according to size and quality.",
      "6. Handpicked: For the premium Gold and Diamond option, selected pieces are manually filtered and sorted.",
      "7. Packaging: The selected product is packed in hygienic packaging.",
      "From a seed that grows in water to your snack bowl — Makhana's journey is full of traditional processing, careful selection and care.",
    ],
    coverImageLabel: "From Pond to Packet",
    imagePath: "/products/shrestha-hero.jpg",
    author: "ItarIntakes Team",
    category: "Makhana Knowledge",
    tags: ["makhana", "process", "handpicked", "shrestha"],
  ...
  {
    id: "a8",
    slug: "how-to-enjoy-makhana",
    title: "How to Enjoy Makhana: 5 Easy Ideas",
    excerpt: "Roasted, masala, chaat, kheer or a dry-fruit mix — simple ways to enjoy Shrestha Makhana.",
    content: [
      "Makhana is light, crunchy and versatile. Here are five simple ways to enjoy Shrestha Silver, Gold or Diamond Makhana.",
      "Roasted Makhana — lightly roast and add your favourite seasoning.",
      "Masala Makhana — add spices to roasted Makhana.",
      "Makhana Chaat — toss with vegetables, chutney and seasoning.",
      "Makhana Kheer — a traditional dessert.",
      "Dry Fruit Mix — combine with nuts and dry fruits.",
    ],
    coverImageLabel: "Ways to Enjoy Makhana",
    imagePath: "/products/shrestha-gold-makhana.jpg",
    author: "ItarIntakes Team",
    category: "Recipes",
    tags: ["recipes", "makhana", "shrestha"],
    publishDate: "2026-09-26",
    status: "published",
  },
  {
